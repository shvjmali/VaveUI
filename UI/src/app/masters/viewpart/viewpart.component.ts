...
// export class ViewPartComponent1 implements OnChanges {
//     images:any[];    
//     filterBy?: string = 'all'    
//     allImages:any[] = [];    
    
//   constructor(private _viewPartService: ViewPartService) {    
...
export class ViewPartComponent {
    ...
    ngOnInit(){
        ...
        // this._UserService.Login(this.currentUser).subscribe(
        //     res => {
        //       this.loading = false;
        //       this.ngZone.run(() => {
        //         if (res) {
